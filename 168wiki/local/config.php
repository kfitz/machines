...
$WikiTitle = 'writing machines';


##  $ScriptUrl is your preferred URL for accessing wiki pages
##  $PubDirUrl is the URL for the pub directory.
### Turing this on breaks editing. WFT??
# $ScriptUrl = 'http://machines.plannedobsolescence.net/168wiki';
# $PubDirUrl = 'http://machines.plannedobsolescence.net/168wiki/pub';
...
## and PmWiki.PasswordsAdmin.
 ...
 $DefaultPasswords['admin'] = crypt('aithoa');
 $DefaultPasswords['edit'] = crypt('sagehen');
...
## Use thhe group's page template for new pages
...
$EnableUpload = 1;                       
$DefaultPasswords['upload'] = crypt('sagehen');
$UploadDir = "/home/plannedo/machines.plannedobsolescence.net/168wiki/files";
$UploadUrlFmt = "http://machines.plannedobsolescence.net/168wiki/files";
...
##  revision history.  The default is 3650 (approximately 10 years).
 $DiffKeepDays=90;                        # keep page history at least 90 days
